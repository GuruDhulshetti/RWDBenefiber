...
<li>
  <img id="C0" src="foundation/Images/Large/Slider-Image.jpg"
  data-interchange="[foundation/Images/Small/Slider-Image.jpg, (default)],[foundation/Images/Large/Slider-Image.jpg, (small)]" alt="Slider-Image" onclick="OpenLink('/products/powder',this)" />
</li><li>
  ...
  data-interchange="[foundation/Images/Small/fbslide.jpg, (default)],[foundation/Images/Large/fbslide.jpg, (small)]" alt="FB slide" onclick="OpenLink('https://www.facebook.com/Benefiber',this)" />
    ...
    <div class="large-11  small-11 large-centered small-centered columns ">
        <div class="large-12 small-12 columns products-brief">
            <h3>Benefiber<sup>®</sup></h3>The Clear Choice<p>Benefiber<sup>®</sup> allows you to choose how you want to take your fiber, offering a variety of easy options that fit your lifestyle. It is even great for cooking. Look to Benefiber<sup>®</sup> for a complete line of fiber products.</p>
        </div>
    </div>
    <hr />
    ...
    <div class="row searchable">
     ...
     <div class="large-12 columns product-grid-div ">
            <h4 class="pg-title"></h4>
            <ul class="small-block-grid-2 large-block-grid-2 product-grid">
                <li>
  <a href="<s:url namespace="products" action="powder"></s:url>">
    <div class="ratio loading">
      <img class="lazy" data-original="./foundation/Images/Large/Grit-Free-Powder.jpg"  alt="" data-interchange="[foundation/Images/Small/Grit-Free-Powder.jpg, (default)],[foundation/Images/Large/Grit-Free-Powder.jpg, (small)]"  />
    </div>
  </a>
  <div class="product-tag">
    <span>
    </span>
    <a href="/Products/powder">
      <h4>Grit-Free Powder</h4>
    </a>
  </div>
</li><li>
  <a href="/products/coupon">
    <div class="ratio loading">
      <img class="lazy" data-original="./foundation/Images/Large/Save-on-purchase.jpg"  alt="" data-interchange="[foundation/Images/Small/Save-on-Purchase.jpg, (default)],[foundation/Images/Large/Save-on-Purchase.jpg, (small)]"  />
    </div>
  </a>
  <div class="product-tag">
    <span>
    ...
    <a href="/products/coupon">
      <h4>Save $3.00 on Next Purchase</h4>
    </a>
  </div>
</li>
            </ul>
