 <%@taglib uri="/struts-tags" prefix="s"%>
    ...
    <div class="large-12 small-12 small-centered  large-centered columns sitemapbg ">
        <div class="top-band">
            <h3>Site Map</h3>
        </div>

        <ul class="small-block-grid-1 large-block-grid-2 sitemapblocklist">
            <li>
                <ul class="sitemaplist">
                    <li><a href="<s:url namespace="products" action="locator"></s:url>">Find Benefiber<sup>®</sup> Near You</a></li>
                     <li><a href="<s:url namespace="/" action="productshome"></s:url>">Products Home</a></li>
                    <li><a href="<s:url namespace="products" action="powder"></s:url>">Benefiber<sup>®</sup> Powder</a></li>
                    <li><a href="#">Fiber & Your Health</a>
                        <ul>
                            <li><a href="<s:url namespace="/" action="fiber-your-health"></s:url>">Fiber & Your Health Home</a></li>
                            <li><a href="<s:url namespace="/" action="fiber-rich-diet"></s:url>">Fiber-Rich Diet</a></li>
                            <li><a href="<s:url namespace="/" action="fiber-iq"></s:url>">Test Your Fiber IQ</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li>
                <ul class="sitemaplist">
                    <li><a href="#">Recipes</a>
                        <ul>
                            <li><a href="<s:url namespace="/" action="recipes"></s:url>">Recipes Home</a></li>
                            <li><a href="<s:url namespace="/" action="irish-oatmeal"></s:url>">Irish Oatmeal with Strawberries & Vanilla</a></li>
                            <li><a href="<s:url namespace="/" action="blueberry_muffin"></s:url>">Blueberry Muffin</a></li>
                            <li><a href="<s:url namespace="/" action="buttermilk-buckwheat"></s:url>">Buttermilk Buckwheat Pancakes</a></li>
                            <li><a href="<s:url namespace="/" action="strawberry-almond"></s:url>">Strawberry, Almond Yogurt Smoothie</a></li>
                            <li><a href="<s:url namespace="/" action="whole-wheat-english"></s:url>">Whole Wheat English Muffin with Peanut Butter & Banana</a></li>
                            <li><a href="<s:url namespace="/" action="celery-stick-with-salty"></s:url>">Celery Stick with Salty Almond Butter</a></li>
                        </ul>
                    </li>
                    <li><a href="<s:url namespace="/" action="faq"></s:url>">FAQs</a></li>
                    <li><a href="<s:url namespace="/" action="signup"></s:url>">Sign Up</a></li>
                    <li><a href="<s:url namespace="/" action="privacypolicy"></s:url>">Privacy Policy</a></li>
                    <li><a href="<s:url namespace="/" action="termsofuse"></s:url>">Terms of Use</a></li>
                    <li><a href="<s:url namespace="/" action="contact_us"></s:url>">Contact Us</a></li>
                </ul>
            </li>
        </ul>
    </div>
